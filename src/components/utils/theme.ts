...
export const ItemCardImage =
  'flex justify-center items-center w-5/12 xxl:w-4/12 relative aspect-square rounded overflow-hidden bg-gray-200 flex-shrink-0 mr-4';
...
export const InstagramItemBase =
  'instagram-card block rounded-lg overflow-hidden transition-all duration-150';
